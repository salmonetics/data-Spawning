...
#update on 3/4/2019
#cax <- combineCAX("ca-data-all 02-08-2019 18 55_NOSA.csv","ca-data-all 02-08-2019 18 55_JuvOut.csv","ca-data-all 02-08-2019 18 55_PreSmolt.csv","ca-metadata_02-08-2019.csv")
#write.csv(cax,"CAX_data_03-04-2019.csv",row.names=FALSE)

#cax <- combineCAX("ca-data-all 03-22-2019_NOSA.csv","ca-data-all 03-22-2019_JuvOut.csv","ca-data-all 03-22-2019_PreSmolt.csv","CAX_metadata_03-22-2019.csv")
#write.csv(cax,"CAX_data_03-22-2019.csv",row.names=FALSE)

cax <- combineCAX("ca-data-all 04-12-2019_NOSA.csv","ca-data-all 04-12-2019_JuvOut.csv","ca-data-all 04-12-2019_PreSmolt.csv","CAX_metadata_04-15-2019.csv")
write.csv(cax,"CAX_data_04-15-2019.csv",row.names=FALSE)
...
write.csv(gmeans.all,"CAX_geomeans_4-15-2019.csv",row.names=F)
...
cax <- read.csv("ca-data-all 04-12-2019_NOSA.csv",stringsAsFactors=FALSE)
